 ...
 * @version 2017-04-01
 */
public class SmsAddresslistInfo extends DataEntity<SmsAddresslistInfo> {
	...
	private SmsAddresslistGroup group;
	
	public SmsAddresslistGroup getGroup() {
		return group;
	}

	public void setGroup(SmsAddresslistGroup group) {
		this.group = group;
	}

	public SmsAddresslistInfo() {
		super();
	}

	public SmsAddresslistInfo(String id){
		super(id);
	}
