 ...
 * @version 2017-06-26
 */
public class SmsSend extends DataEntity<SmsSend> {
	...
	private Date sendTimeQ;				// 发送时间起
	private Date sendTimeZ;				// 发送时间止
	private String resultStatus;		// 结果
	...
	public Date getSendTimeQ() {
		return sendTimeQ;
	}

	public void setSendTimeQ(Date sendTimeQ) {
		this.sendTimeQ = sendTimeQ;
	}

	public Date getSendTimeZ() {
		return sendTimeZ;
	}

	public void setSendTimeZ(Date sendTimeZ) {
