 ...
 */
package com.sanerzone.jeebase.common.persistence;
...
import com.sanerzone.jeebase.common.utils.CookieUtils;
...
//		sb.insert(0,"<div class=\"page\">\n").append("</div>\n");
	...
	public String toString2() {
		...
		if (pageNo != first) {// 如果是首页
			sb.append("<a href='javascript:void(0);' onclick=\""+funcName+"("+prev+","+pageSize+",'"+funcParam+"');\" class='ft'> << </a>");
		}
		...
		for (int i = begin; i <= end; i++) {
			if (i == pageNo) {
				sb.append("<a href='javascript:void(0);' class='on'> "+(i + 1 - first)+"</a>");
			} else {
				sb.append("<a href='javascript:void(0);' onclick=\""+funcName+"("+i+","+pageSize+",'"+funcParam+"');\"> "+(i + 1 - first)+"</a>");
			}
		}
		...
		/*for(int i=1; i<=last; i++){
			if(pageNo == i){
				sb.append("<a href='javascript:void(0);' class='on' onclick=\""+funcName+"("+pageNo+","+pageSize+",'"+funcParam+"');\"> "+i+"</a>");
			}
			else
			{
				sb.append("<a href='javascript:void(0);' onclick=\""+funcName+"("+pageNo+","+pageSize+",'"+funcParam+"');\"> "+i+"</a>");
			}
		}*/
		if(pageNo != last){
			sb.append("<a href='javascript:void(0);' onclick=\""+funcName+"("+next+","+pageSize+",'"+funcParam+"');\" class='ft'> >> </a>");
		}
		sb.append("<span>共<em>"+last+"</em>页</span>");
