...
public class FormAuthenticationFilter extends org.apache.shiro.web.filter.authc.FormAuthenticationFilter {
	...
	public static final String DEFAULT_GOURL_PARAM = "goUrl";

	private String captchaParam = DEFAULT_CAPTCHA_PARAM;
	private String mobileLoginParam = DEFAULT_MOBILE_PARAM;
	private String messageParam = DEFAULT_MESSAGE_PARAM;
	private String goUrlParam = DEFAULT_GOURL_PARAM;
	...
	public String getSuccessUrl(ServletRequest request) {
		String goUrl = WebUtils.getCleanParam(request, goUrlParam);
		return goUrl==null?super.getSuccessUrl():goUrl;
	}
...
//		}
	...
	protected boolean onLoginSuccess(AuthenticationToken token, Subject subject,
		...
		if (!"XMLHttpRequest".equalsIgnoreCase(httpServletRequest
            ...
            out.println("{\"code\":\"0\",\"message\":\"登入成功\"}");
            out.flush();
            out.close();
        }
	return false;
	...
	protected boolean onLoginFailure(AuthenticationToken token,
        ...
        try {
            ...
            out.println("{\"code\":\"1\",\"message\":\""+message+"\"}");
            out.flush();
            out.close();
