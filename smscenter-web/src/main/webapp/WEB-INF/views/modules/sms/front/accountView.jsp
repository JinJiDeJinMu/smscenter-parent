                ...
                <div class="form">
                    ...
                    <dl class="clearfix">
                   	...
                   	<dl class="clearfix">
                        <dt>应用状态</dt>
                        <dd>
                        	<c:if test="${entity.accStatus eq 1}">
                        		上线
                        	</c:if>
                        	<c:if test="${entity.accStatus eq 0}">
                        		下线
                        	</c:if>
                        	<c:if test="${entity.accStatus eq -1}">
                        		未上线
                        	</c:if>
                        	<c:if test="${entity.accStatus eq -2}">
                        		未上线
                        	</c:if>
                        </dd>
                    </dl>
                    <c:if test="${not empty entity.callBackUrl && entity.callBackUrl !=''}">
                   	<dl class="clearfix">
                        <dt>应用回调地址</dt>
                        <dd>
                            ${entity.callBackUrl}
