	...
	<script type="text/javascript">
		...
		function refreshSelect()
		{
			$("[id$='gatewayId']").change(function() 
			{
				...
				$.ajax({
					url : "${ctx}/sms/smsGateway/getGatewayInfo?gwCode="+$(this).children('option:selected').val(),
					dataType : "json",
			...
			$("[id='type']").change(function()
			{
				...
				$.ajax({
					url : "${ctx}/sms/smsGateway/getGatewayInfoList?type="+$(this).children('option:selected').val(),
					dataType : "json",
					success : function(data) {
						gatewaySelect.empty();
						html += '<option value="">请选择</option>';
						$.each(data,function(i,data){
							html += '<option value="'+data.id+'">'+data.gwName+'</option>';
			            });
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sms/smsSign/config?id=${smsSign.id}">信息<shiro:hasPermission name="sms:smsSign:edit">${not empty smsSign.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sms:smsSign:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="smsSign" action="${ctx}/sms/smsSign/batchSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table id="contentTable" class="table table-striped table-bordered table-condensed">
			<thead>
				<tr>
					...
					<th>扩展号</th>
					<th>备注</th>
					<shiro:hasPermission name="sms:smsSign:edit"><th>操作</th></shiro:hasPermission>
				</tr>
			</thead>
			<tbody id="gatewaySigns">
				<tr>
					...
					<td>
						<select id="gatewaySignList0_gatewayId" name="gatewaySignList[0].gwCode" class="input-xlarge ">
							<option value="">请选择</option>
							<option value="JYC">请选择</option>
						</select>
					</td>
					<td>
					...
					<td>
						...
						<input id="gatewaySignList0_note" name="gatewaySignList[0].remarks" htmlEscape="false" maxlength="100" class="input-large"/>
					</td>
					<shiro:hasPermission name="sms:smsSign:edit"><td>
				...
				<tr>
					...
					<td>
						<select id="gatewaySignList1_gatewayId" name="gatewaySignList[1].gwCode" class="input-xlarge ">
							<option value="">请选择</option>
						</select>
					</td>
					<td>
					...
					<td>
						<%-- <form:textarea path="note" htmlEscape="false" rows="3" class="input-large" id="note"/> --%>
						<input id="gatewaySignList1_note" name="gatewaySignList[1].remarks" htmlEscape="false" maxlength="100" class="input-large"/>
					</td>
					<shiro:hasPermission name="sms:smsSign:edit"><td>
				...
				<tr>
					...
					<td>
						<select id="gatewaySignList2_gatewayId" name="gatewaySignList[2].gwCode" class="input-xlarge ">
							<option value="">请选择</option>
						</select>
					</td>
					<td>
					...
					<td>
						<%-- <form:textarea path="note" htmlEscape="false" rows="3" class="input-large" id="note"/> --%>
						<input id="gatewaySignList2_note" name="gatewaySignList[2].remarks" htmlEscape="false" maxlength="100" class="input-large"/>
					</td>
					<shiro:hasPermission name="sms:smsSign:edit"><td>
				...
				<tr>
					...
					<td>
						<select id="gatewaySignList3_gatewayId" name="gatewaySignList[3].gwCode" class="input-xlarge ">
							<option value="">请选择</option>
						</select>
					</td>
					<td>
					...
					<td>
						<%-- <form:textarea path="note" htmlEscape="false" rows="3" class="input-large" id="note"/> --%>
						<input id="gatewaySignList3_note" name="gatewaySignList[3].remarks" htmlEscape="false" maxlength="100" class="input-large"/>
					</td>
					<shiro:hasPermission name="sms:smsSign:edit"><td>
				...
				<tr>
					...
					<td>
						<select id="gatewaySignList4_gatewayId" name="gatewaySignList[4].gwCode" class="input-xlarge ">
							<option value="">请选择</option>
						</select>
					</td>
					<td>
					...
					<td>
						<%-- <form:textarea path="note" htmlEscape="false" rows="3" class="input-large" id="note"/> --%>
						<input id="gatewaySignList4_note" name="gatewaySignList[4].remarks" htmlEscape="false" maxlength="100" class="input-large"/>
					</td>
					<shiro:hasPermission name="sms:smsSign:edit"><td>
				...
				<tr>
					...
					<td>
						<select id="gatewaySignList5_gatewayId" name="gatewaySignList[5].gwCode" class="input-xlarge ">
							<option value="">请选择</option>
						</select>
					</td>
					<td>
					...
					<td>
						<%-- <form:textarea path="note" htmlEscape="false" rows="3" class="input-large" id="note"/> --%>
						<input id="gatewaySignList5_note" name="gatewaySignList[5].remarks" htmlEscape="false" maxlength="100" class="input-large"/>
					</td>
					<shiro:hasPermission name="sms:smsSign:edit"><td>
				...
				<tr>
					...
					<td>
						<select id="gatewaySignList6_gatewayId" name="gatewaySignList[6].gwCode" class="input-xlarge ">
							<option value="">请选择</option>
						</select>
					</td>
					<td>
					...
					<td>
						<%-- <form:textarea path="note" htmlEscape="false" rows="3" class="input-large" id="note"/> --%>
						<input id="gatewaySignList6_note" name="gatewaySignList[6].remarks" htmlEscape="false" maxlength="100" class="input-large"/>
					</td>
					<shiro:hasPermission name="sms:smsSign:edit"><td>
				...
				<tr>
					...
					<td>
						<select id="gatewaySignList7_gatewayId" name="gatewaySignList[7].gwCode" class="input-xlarge ">
							<option value="">请选择</option>
						</select>
					</td>
					<td>
					...
					<td>
						<%-- <form:textarea path="note" htmlEscape="false" rows="3" class="input-large" id="note"/> --%>
						<input id="gatewaySignList7_note" name="gatewaySignList[7].remarks" htmlEscape="false" maxlength="100" class="input-large"/>
					</td>
					<shiro:hasPermission name="sms:smsSign:edit"><td>
				...
				<tr>
					...
					<td>
						<select id="gatewaySignList8_gatewayId" name="gatewaySignList[8].gwCode" class="input-xlarge ">
							<option value="">请选择</option>
						</select>
					</td>
					<td>
					...
					<td>
						<%-- <form:textarea path="note" htmlEscape="false" rows="3" class="input-large" id="note"/> --%>
						<input id="gatewaySignList8_note" name="gatewaySignList[8].remarks" htmlEscape="false" maxlength="100" class="input-large"/>
					</td>
					<shiro:hasPermission name="sms:smsSign:edit"><td>
				...
				<tr>
					...
					<td>
						<select id="gatewaySignList9_gatewayId" name="gatewaySignList[9].gwCode" class="input-xlarge ">
							<option value="">请选择</option>
						</select>
					</td>
					<td>
					...
					<td>
						<%-- <form:textarea path="note" htmlEscape="false" rows="3" class="input-large" id="note"/> --%>
						<input id="gatewaySignList9_note" name="gatewaySignList[9].remarks" htmlEscape="false" maxlength="100" class="input-large"/>
					</td>
					<shiro:hasPermission name="sms:smsSign:edit"><td>
		...
		<script type="text/template" id="gatewaySignsTpl">
			<tr id="gatewaySigns{{idx}}">
				...
				<td>
					<select id="gatewaySignList{{idx}}_gatewayId" name="gatewaySignList[{{idx}}].gwCode" class="input-xlarge ">
						<option value="">请选择</option>
					</select>
				</td>
				<td>
				...
				<td>
					<%-- <form:textarea path="note" htmlEscape="false" rows="3" class="input-large" id="note"/> --%>
					<input id="gatewaySignList{{idx}}_note" name="gatewaySignList[{{idx}}].remarks" htmlEscape="false" maxlength="100" class="input-large"/>
				</td>
				<shiro:hasPermission name="sms:smsSign:edit"><td>
