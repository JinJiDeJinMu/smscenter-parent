...
<body>
	...
	<div class="container-fluid breadcrumb">
		<div class="row-fluid span12">
			...
			<span class="span4">角色标识: ${role.enname}</span>
		</div>
		<div class="row-fluid span8">
			<span class="span4">角色类型: ${role.roleType eq 0 ? '系统角色' : '业务角色'}</span>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>归属机构</th><th>登录名</th><th>姓名</th><th>电话</th><th>手机</th><shiro:hasPermission name="sys:user:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
