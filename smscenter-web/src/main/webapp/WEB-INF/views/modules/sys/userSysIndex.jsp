    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="ibox float-e-margins data_today">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-xs-8 text"><span class="fa fa-arrow-circle-o-right"></span> 今日发送(条)</div>
                        <div class="col-xs-4 text-right"><span class="badge badge_success">${smsDayReport.successCount}</span></div>
                    </div>
                    <c:if test="${smsDayReport.successCount > 0}">
                    <div class="row success">
                        <div class="col-xs-12 text"><span class="fa fa-arrow-circle-o-right"></span> 到达率统计</div>
                        <div class="col-xs-6">　• 成功率</div>
                        <div class="col-xs-6 text-right"><span class="text-"><fmt:formatNumber type="number" value="${smsDayReport.reportSuccessCount*100/smsDayReport.successCount}" maxFractionDigits="2" pattern="0.00"></fmt:formatNumber>%</span></div>
                        <div class="col-xs-6">　• 失败率</div>
                        <div class="col-xs-6 text-right"><span class="text-"><fmt:formatNumber type="number" value="${smsDayReport.reportFailCount*100/smsDayReport.successCount}" maxFractionDigits="2" pattern="0.00"></fmt:formatNumber>%</span></div>
                        <div class="col-xs-6">　• 未知率</div>
                        <div class="col-xs-6 text-right"><span class="text-"><fmt:formatNumber type="number" value="${smsDayReport.reportNullCount*100/smsDayReport.successCount}" maxFractionDigits="2" pattern="0.00"></fmt:formatNumber>%</span></div>
                    </div>
                    </c:if>
                    <c:if test="${smsDayReport.successCount <= 0}">
                    <div class="row success">
                    ...
                    <div class="row">
                        <div class="col-xs-8 text"><span class="fa fa-arrow-circle-o-right"></span> 请求失败(条)</div>
                        <div class="col-xs-4 text-right"><span class="badge">${smsDayReport.submitFailCount}</span></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content navlink">
                    <div class="row">
                        <div class="col-xs-2">
                            <a href="javascript:parent.addTabChild(this, '发信箱', '${ctx}/sms/smsOutbox/smsGroupInit');" class="clearfix navlink1">
                                <p><span class="fa fa-pencil"></span>写 短 信 </p>
                            </a>
                        </div>
                        <div class="col-xs-2">
                            <a href="javascript:parent.addTabChild(this, '发信箱','${ctx}/sms/smsOutbox/userSendListInit');" class="clearfix navlink2">
                                <p><span class="fa fa-envelope"></span>发 信 箱 </p>
                            </a>
                        </div>
                        <div class="col-xs-2">
                            <a href="javascript:parent.addTabChild(this, '收信箱','${ctx}/sms/smsInbox/userReceiveListInit');" class="clearfix navlink3">
                                <p><span class="fa fa-envelope"></span>收 信 箱 </p>
                            </a>
                        </div>
                        <div class="col-xs-2">
                            <a href="javascript:parent.addTabChild(this, '联系人','${ctx}/sms/smsAddresslistInfo/index');" class="clearfix navlink4">
                                <p><span class="fa fa-comments-o"></span>联 系 人</p>
                            </a>
                        </div>
                        <div class="col-xs-2">
                            <a href="javascript:parent.addTabChild(this, '群组管理','${ctx}/sms/smsAddresslist/index');" class="clearfix navlink5">
                                <p><span class="fa fa-users"></span>群组管理</p>
                            </a>
                        </div>
                        <div class="col-xs-2">
                            <a href="javascript:parent.addTabChild(this, '批量导入','${ctx}/sms/smsAddresslistInfo/batchForm');" class="clearfix navlink6">
