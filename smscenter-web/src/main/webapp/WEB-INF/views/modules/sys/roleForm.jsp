...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<input type="hidden" name="sysData" value="1">
		<input type="hidden" name="useable" value="1">
		<input type="hidden" name="dataScope" value="2">
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="roleType" class="input-medium">
					<form:option value="0">系统角色</form:option>
					<form:option value="1">业务角色</form:option>
				</form:select>
			</div>
		</div>
		<%-- <div class="control-group">
