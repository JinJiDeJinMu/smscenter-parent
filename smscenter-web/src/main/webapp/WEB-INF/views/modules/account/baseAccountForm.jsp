...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/account/baseAccount/">信息列表</a></li>
		<li class="active"><a href="${ctx}/account/baseAccount/form?id=${baseAccount.id}">信息<shiro:hasPermission name="account:baseAccount:edit">${not empty baseAccount.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="account:baseAccount:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="baseAccount" action="${ctx}/account/baseAccount/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<form:hidden path="user.id"/>
		<input type="hidden" name="accType" value="sms">
		<input type="hidden" name="accStatus" value="1">
		...
		<%@ include file="/WEB-INF/views/modules/account/baseAccountOptions.jsp"%>
