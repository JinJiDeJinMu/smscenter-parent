...
public class DateHelper extends org.apache.commons.lang3.time.DateUtils {
	...
	public static Date getDay(Date date,String time){
		String dateCn = formatDate(date, "yyyy-MM-dd")+" "+time;
		return parseDate(dateCn);
	}
	...
	public static String formatCmppDate(Date date) {
        if (null == date) {
...
//		System.out.println(time/(24*60*60*1000));
		...
		System.out.println(getDay(new Date(), "13:24:25"));
	}
}
